...
public class MainActivity extends AppCompatActivity {
    ...
    public void Llamar(View view){
        Intent llamar= new Intent(Intent.ACTION_DIAL,Uri.parse("tel:2311507732"));
    ...
    public  void MandarImag(View view, String phoneNumber, String nombreImagen){
        try {
            ...
            intent.putExtra(Intent.EXTRA_STREAM, Uri.parse(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS) + "/" + nombreImagen));
            intent.putExtra("images (13).jpeg", "2313295172" + "@s.whatsapp.net"); //numero telefonico sin prefijo "+"!
